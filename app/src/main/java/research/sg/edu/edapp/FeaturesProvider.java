...
public class FeaturesProvider extends ContentProvider {

    static final String PROVIDER_NAME = "research.sg.edu.edapp.FeaturesProvider";
    static final String URL = "content://" + PROVIDER_NAME + "/EmoFeatures";
    ...
    static {
        ...
        uriMatcher.addURI(PROVIDER_NAME, "EmoFeatures", uriCode);
        uriMatcher.addURI(PROVIDER_NAME, "EmoFeatures/*", uriCode);
    }
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case uriCode:
                return "vnd.android.cursor.dir/EmoFeatures";
    ...
    public class DBHelper extends SQLiteOpenHelper {
        ...
        public static final String DATABASE_NAME = "EmoFeatures.db";
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            // TODO: MINE F table initialization ADDED
            String SQL_CREATE_ENTRIES =
                    "CREATE TABLE " + FeaturesDetails.FeaturesEntry.TABLE_NAME + " (" +
                            ...
                            FeaturesDetails.FeaturesEntry.SWIPEDURATION + REAL_TYPE +

                            " )";

            db.execSQL(SQL_CREATE_ENTRIES);
            System.out.println("Features Table created successfully");
        }
