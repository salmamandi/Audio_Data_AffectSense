 ...
 */
public class CandleDataSet extends LineScatterCandleRadarDataSet<research.sg.edu.edapp.ChartLibs.data.CandleEntry> implements ICandleDataSet {
    ...
    public CandleDataSet(List<research.sg.edu.edapp.ChartLibs.data.CandleEntry> yVals, String label) {
        super(yVals, label);
    }

    @Override
    public research.sg.edu.edapp.ChartLibs.data.DataSet<research.sg.edu.edapp.ChartLibs.data.CandleEntry> copy() {

        List<research.sg.edu.edapp.ChartLibs.data.CandleEntry> yVals = new ArrayList<research.sg.edu.edapp.ChartLibs.data.CandleEntry>();
        yVals.clear();
    ...
    @Override
    protected void calcMinMax(research.sg.edu.edapp.ChartLibs.data.CandleEntry e) {
