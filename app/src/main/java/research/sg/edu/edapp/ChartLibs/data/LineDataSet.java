...
import research.sg.edu.edapp.ChartLibs.formatter.DefaultFillFormatter;
import research.sg.edu.edapp.ChartLibs.formatter.IFillFormatter;
...
public class LineDataSet extends LineRadarDataSet<research.sg.edu.edapp.ChartLibs.data.Entry> implements ILineDataSet {
    ...
    public LineDataSet(List<research.sg.edu.edapp.ChartLibs.data.Entry> yVals, String label) {
        super(yVals, label);
