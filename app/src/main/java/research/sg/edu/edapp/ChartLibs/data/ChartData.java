...
public abstract class ChartData<T extends IDataSet<? extends Entry>> {
     ...
     * @param dataSetIndex
     */
    public void addEntry(research.sg.edu.edapp.ChartLibs.data.Entry e, int dataSetIndex) {
     ...
     * @param axis
     */
    protected void calcMinMax(research.sg.edu.edapp.ChartLibs.data.Entry e, AxisDependency axis) {
     ...
     * @param dataSetIndex
     */
    public boolean removeEntry(research.sg.edu.edapp.ChartLibs.data.Entry e, int dataSetIndex) {
    ...
    public boolean removeEntry(float xValue, int dataSetIndex) {
        ...
        research.sg.edu.edapp.ChartLibs.data.Entry e = dataSet.getEntryForXValue(xValue, Float.NaN);
     ...
     * @return
     */
    public T getDataSetForEntry(research.sg.edu.edapp.ChartLibs.data.Entry e) {
