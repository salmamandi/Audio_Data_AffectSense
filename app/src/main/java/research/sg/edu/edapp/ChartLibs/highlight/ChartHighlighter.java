...
public class ChartHighlighter<T extends BarLineScatterCandleBubbleDataProvider> implements IHighlighter
{
     ...
     */
    protected List<research.sg.edu.edapp.ChartLibs.highlight.Highlight> mHighlightBuffer = new ArrayList<research.sg.edu.edapp.ChartLibs.highlight.Highlight>();
    ...
    public research.sg.edu.edapp.ChartLibs.highlight.Highlight getHighlight(float x, float y) {
        ...
        research.sg.edu.edapp.ChartLibs.highlight.Highlight high = getHighlightForX(xVal, x, y);
        return high;
    }
     ...
     * @return
     */
    protected research.sg.edu.edapp.ChartLibs.highlight.Highlight getHighlightForX(float xVal, float x, float y) {

        List<research.sg.edu.edapp.ChartLibs.highlight.Highlight> closestValues = getHighlightsAtXValue(xVal, x, y);
        ...
        research.sg.edu.edapp.ChartLibs.highlight.Highlight detail = getClosestHighlightByPixel(closestValues, x, y, axis, mChart.getMaxHighlightDistance());
     ...
     * @return
     */
    protected float getMinimumDistance(List<research.sg.edu.edapp.ChartLibs.highlight.Highlight> closestValues, float pos, YAxis.AxisDependency axis) {

        float distance = Float.MAX_VALUE;

        for (int i = 0; i < closestValues.size(); i++) {

            research.sg.edu.edapp.ChartLibs.highlight.Highlight high = closestValues.get(i);
    ...
    protected float getHighlightPos(research.sg.edu.edapp.ChartLibs.highlight.Highlight h) {
        return h.getYPx();
    }
     ...
     * @return
     */
    protected List<research.sg.edu.edapp.ChartLibs.highlight.Highlight> getHighlightsAtXValue(float xVal, float x, float y) {
     ...
     * @return
     */
    protected List<research.sg.edu.edapp.ChartLibs.highlight.Highlight> buildHighlights(IDataSet set, int dataSetIndex, float xVal, DataSet.Rounding rounding) {

        ArrayList<research.sg.edu.edapp.ChartLibs.highlight.Highlight> highlights = new ArrayList<>();
        ...
        for (Entry e : entries) {
            ...
            highlights.add(new research.sg.edu.edapp.ChartLibs.highlight.Highlight(
                    e.getX(), e.getY(),
     ...
     * @return
     */
    public research.sg.edu.edapp.ChartLibs.highlight.Highlight getClosestHighlightByPixel(List<research.sg.edu.edapp.ChartLibs.highlight.Highlight> closestValues, float x, float y,
