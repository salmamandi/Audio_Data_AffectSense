 ...
 */
public abstract class DataSet<T extends research.sg.edu.edapp.ChartLibs.data.Entry> extends BaseDataSet<T> {
    ...
    @Override
    public int getEntryIndex(research.sg.edu.edapp.ChartLibs.data.Entry e) {
        ...
        if (closest != -1) {
            ...
            if (!Float.isNaN(closestToY)) {
                ...
                while (true) {
                    ...
                    final research.sg.edu.edapp.ChartLibs.data.Entry value = mValues.get(closest);
