...
public class BarHighlighter extends ChartHighlighter<BarDataProvider> {
    ...
    public research.sg.edu.edapp.ChartLibs.highlight.Highlight getHighlight(float x, float y) {
        research.sg.edu.edapp.ChartLibs.highlight.Highlight high = super.getHighlight(x, y);
     ...
     * @return
     */
    public research.sg.edu.edapp.ChartLibs.highlight.Highlight getStackedHighlight(research.sg.edu.edapp.ChartLibs.highlight.Highlight high, IBarDataSet set, float xVal, float yVal) {
        ...
        if (entry.getYVals() == null) {
            ...
            research.sg.edu.edapp.ChartLibs.highlight.Range[] ranges = entry.getRanges();
            ...
            if (ranges.length > 0) {
                ...
                research.sg.edu.edapp.ChartLibs.highlight.Highlight stackedHigh = new research.sg.edu.edapp.ChartLibs.highlight.Highlight(
                        entry.getX(),
                        entry.getY(),
                        (float) pixels.x,
                        (float) pixels.y,
     ...
     * @return
     */
    protected int getClosestStackIndex(research.sg.edu.edapp.ChartLibs.highlight.Range[] ranges, float value) {
