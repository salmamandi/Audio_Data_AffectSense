...
import research.sg.edu.edapp.ChartLibs.charts.PieRadarChartBase;
...
public abstract class PieRadarHighlighter<T extends PieRadarChartBase> implements IHighlighter
{
     ...
     * @return
     */
    protected abstract research.sg.edu.edapp.ChartLibs.highlight.Highlight getClosestHighlight(int index, float x, float y);
}
