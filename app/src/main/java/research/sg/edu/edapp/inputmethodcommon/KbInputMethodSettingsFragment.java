 ...
 */
public abstract class KbInputMethodSettingsFragment extends PreferenceFragment
        implements KbInputMethodSettingsInterface {
    private final KbInputMethodSettingsImpl mSettings = new KbInputMethodSettingsImpl();
    @Override
