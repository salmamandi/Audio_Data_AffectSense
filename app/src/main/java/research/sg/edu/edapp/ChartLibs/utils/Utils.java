...
import research.sg.edu.edapp.ChartLibs.formatter.DefaultValueFormatter;
...
public abstract class Utils {
     ...
     */
    public static research.sg.edu.edapp.ChartLibs.utils.FSize calcTextSize(Paint paint, String demoText) {

        research.sg.edu.edapp.ChartLibs.utils.FSize result = research.sg.edu.edapp.ChartLibs.utils.FSize.getInstance(0,0);
     ...
     */
    public static void calcTextSize(Paint paint, String demoText, research.sg.edu.edapp.ChartLibs.utils.FSize outputFSize) {
    ...
    public static void drawXAxisValue(Canvas c, String text, float x, float y,
        ...
        if (angleDegrees != 0.f) {
            ...
            if (anchor.x != 0.5f || anchor.y != 0.5f) {
                final research.sg.edu.edapp.ChartLibs.utils.FSize rotatedSize = getSizeOfRotatedRectangleByDegrees(
                ...
                research.sg.edu.edapp.ChartLibs.utils.FSize.recycleInstance(rotatedSize);
            }
    ...
    public static void drawMultilineText(Canvas c, String text,
                                         float x, float y,
                                         TextPaint paint,
                                         research.sg.edu.edapp.ChartLibs.utils.FSize constrainedToSize,
                                         MPPointF anchor, float angleDegrees) {
     ...
     * @return A Recyclable FSize instance
     */
    public static research.sg.edu.edapp.ChartLibs.utils.FSize getSizeOfRotatedRectangleByDegrees(research.sg.edu.edapp.ChartLibs.utils.FSize rectangleSize, float degrees) {
     ...
     * @return A Recyclable FSize instance
     */
    public static research.sg.edu.edapp.ChartLibs.utils.FSize getSizeOfRotatedRectangleByRadians(research.sg.edu.edapp.ChartLibs.utils.FSize rectangleSize, float radians) {
        return getSizeOfRotatedRectangleByRadians(rectangleSize.width, rectangleSize.height,
                radians);
    }
     ...
     * @return A Recyclable FSize instance
     */
    public static research.sg.edu.edapp.ChartLibs.utils.FSize getSizeOfRotatedRectangleByDegrees(float rectangleWidth, float
     ...
     * @return A Recyclable FSize instance
     */
    public static research.sg.edu.edapp.ChartLibs.utils.FSize getSizeOfRotatedRectangleByRadians(float rectangleWidth, float
            rectangleHeight, float radians) {
        return research.sg.edu.edapp.ChartLibs.utils.FSize.getInstance(
