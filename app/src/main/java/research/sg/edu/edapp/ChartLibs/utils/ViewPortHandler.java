...
public class ViewPortHandler {
    ...
    public void setDragOffsetX(float offset) {
        mTransOffsetX = research.sg.edu.edapp.ChartLibs.utils.Utils.convertDpToPixel(offset);
    }
    ...
    public void setDragOffsetY(float offset) {
        mTransOffsetY = research.sg.edu.edapp.ChartLibs.utils.Utils.convertDpToPixel(offset);
    }
