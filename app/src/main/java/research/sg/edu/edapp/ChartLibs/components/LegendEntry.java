package research.sg.edu.edapp.ChartLibs.components;
...
public class LegendEntry {
    ...
    public LegendEntry(String label,
                       research.sg.edu.edapp.ChartLibs.components.Legend.LegendForm form,
                       float formSize,
                       float formLineWidth,
     ...
     */
    public research.sg.edu.edapp.ChartLibs.components.Legend.LegendForm form = research.sg.edu.edapp.ChartLibs.components.Legend.LegendForm.DEFAULT;
