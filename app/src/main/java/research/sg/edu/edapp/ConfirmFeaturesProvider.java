...
public class ConfirmFeaturesProvider extends ContentProvider {

    static final String PROVIDER_NAME = "research.sg.edu.edapp.ConfirmFeaturesProvider";
    static final String URL = "content://" + PROVIDER_NAME + "/EmoConfirmFeatures";
    ...
    static {
        ...
        uriMatcher.addURI(PROVIDER_NAME, "EmoConfirmFeatures", uriCode);
        uriMatcher.addURI(PROVIDER_NAME, "EmoConfirmFeatures/*", uriCode);
    }
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case uriCode:
                return "vnd.android.cursor.dir/EmoConfirmFeatures";
    ...
    public class DBHelper extends SQLiteOpenHelper {
        ...
        public static final String DATABASE_NAME = "EmoConfirmFeatures.db";
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            // TODO: MINE Add SQL features here. ADDED
            ...
            String SQL_CREATE_ENTRIES =
                    "CREATE TABLE " + FeaturesDetails.FeaturesEntry.TABLE_NAME + " (" +
                            ...
                            FeaturesDetails.FeaturesEntry.EMOTION + INT_TYPE + COMMA_SEP +
                            ...
                            FeaturesDetails.FeaturesEntry.TYPETIME + REAL_TYPE + COMMA_SEP +
                            FeaturesDetails.FeaturesEntry.SWIPETIME + REAL_TYPE + COMMA_SEP +
                            FeaturesDetails.FeaturesEntry.MODPRESSURE + REAL_TYPE + COMMA_SEP +
                            FeaturesDetails.FeaturesEntry.SDPRESSURE + REAL_TYPE + COMMA_SEP +
                            FeaturesDetails.FeaturesEntry.SDVELOCITY + REAL_TYPE + COMMA_SEP +
                            FeaturesDetails.FeaturesEntry.ISSWIPE + REAL_TYPE +
                            " )";

            db.execSQL(SQL_CREATE_ENTRIES);
            System.out.println("Confirm Features Table created successfully");
        }
