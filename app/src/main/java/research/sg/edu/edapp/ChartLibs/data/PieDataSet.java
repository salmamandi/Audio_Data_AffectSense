...
public class PieDataSet extends research.sg.edu.edapp.ChartLibs.data.DataSet<PieEntry> implements IPieDataSet {
...
//        mShift = Utils.convertDpToPixel(12f);
    ...
    @Override
    public research.sg.edu.edapp.ChartLibs.data.DataSet<PieEntry> copy() {
